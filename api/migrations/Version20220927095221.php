 ...
 */
final class Version20220927095221 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE items (id INT AUTO_INCREMENT NOT NULL, info JSON DEFAULT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, plain_text VARCHAR(255) NOT NULL, icon VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
